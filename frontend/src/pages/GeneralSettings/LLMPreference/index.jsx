...
import WiinsAiLogo from "@/media/llmprovider/wiinsai.png";
...
export const AVAILABLE_LLM_PROVIDERS = [
{
    ...
    description:
      "Retrained by WiinsAi- up to 50% performance improvement at a lower price",
    requiredConfig: [
...
export default function GeneralLLMPreference() {
  ...
  useEffect(() => {
    const SHOW_ONLY = ["generic-openai"];
    const filtered = AVAILABLE_LLM_PROVIDERS.filter((llm) =>
      SHOW_ONLY.includes(llm.value) && llm.name.toLowerCase().includes(searchQuery.toLowerCase())
    );
              ...
              <div className="relative">
                ...
                {searchMenuOpen ? (
                  ...
                  >
                    <div className="flex gap-x-4 items-center">
                      <img
                        src={selectedLLMObject?.logo || WiinsLLMIcon}
