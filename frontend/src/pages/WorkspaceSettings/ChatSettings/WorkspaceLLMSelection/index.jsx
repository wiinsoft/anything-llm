...
const DISABLED_PROVIDERS = ["openai","azure","anthropic","gemini","lmstudio","localai","ollama","togetherai","fireworksai","nvidia-nim","groq","cohere","textgenwebui","bedrock","xai","mistral","perplexity","openrouter","deepseek","apipie","novita","cometapi","litellm","elevenlabs-tts","ppio","dpais","moonshotai","foundry","zai","giteeai","huggingface","koboldcpp"];
