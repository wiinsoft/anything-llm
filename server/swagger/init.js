...
const doc = {
  info: {
    version: "1.0.0",
    title: "WiinsAi LLM Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your WiinsAi LLM instance. UI supplied by Wiinsoft.",
  },
